...
async function getdata(callback) {
      ...
      await fetch('http://climatologia.uprm.edu/assets/coordinates/southernslopes.txt')
        .then(response => response.text())
        .then((data) => sst = data)
        .catch(error => console.error(error));

      await fetch('http://climatologia.uprm.edu/assets/coordinates/easternInterior.txt')
        .then(response => response.text())
        .then((data) => eit = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/southerncoastal.txt')
        .then(response => response.text())
        .then((data) => sct = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/westerninterior.txt')
        .then(response => response.text())
        .then((data) => wit = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/northcoastal.txt')
        .then(response => response.text())
        .then((data) => nct = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/northenslopes.txt')
        .then(response => response.text())
        .then((data) => nst = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/outlyingislandvieques.txt')
        .then(response => response.text())
        .then((data) => oi1t = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/outlyingislandvieques2.txt')
        .then(response => response.text())
        .then((data) => oi2t = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/outlyingislandvieques3.txt')
        .then(response => response.text())
        .then((data) => oi3t = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/outlyingislandculebra.txt')
        .then(response => response.text())
        .then((data) => oi4t = data)
        .catch(error => console.error(error));
      await fetch('http://climatologia.uprm.edu/assets/coordinates/outlyingislandmona.txt')
        .then(response => response.text())
        .then((data) => oi5t = data)
        .catch(error => console.error(error));
